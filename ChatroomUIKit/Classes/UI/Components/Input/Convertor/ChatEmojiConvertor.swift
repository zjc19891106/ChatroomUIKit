...
fileprivate let manager = ChatEmojiConvertor()

final public class ChatEmojiConvertor: NSObject {

    @objc public static let shared = manager

    @objc var emojiMap: Dictionary<String,UIImage> = Appearance.default.emojiMap
