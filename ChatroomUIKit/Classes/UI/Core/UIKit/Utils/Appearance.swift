...
@objcMembers final public class Appearance: NSObject {
    ...
    static var pageContainerTitleBarItemWidth: CGFloat = 114
    
    static var pageContainerConstraintsSize = CGSizeMake(ScreenWidth, ScreenHeight*(3/5.0))
    
    static var giftContainerConstraintsSize = CGSizeMake(ScreenWidth, ScreenHeight/2.0)
    
    /// Description You can change the overall cell layout style of the barrage area by setting the current properties.
    static var barrageCellStyle: ChatBarrageCellStyle = .all
    ...
    static var colorHues: [CGFloat] = [Appearance.primaryHue,Appearance.secondaryHue,Appearance.errorHue,Appearance.neutralHue,Appearance.neutralSpecialHue,Appearance.gradientEndHue]
    ...
    static var emojiMap: Dictionary<String,UIImage> = Dictionary<String,UIImage>()
    
    /// Description language code mirror type.
    static var targetLanguage: LanguageType = .English
    
    /// Description ActionSheet data source.
    static var defaultMessageActions: [ActionSheetItemProtocol] = [ActionSheetItem(title: "Translate".chatroom.localize, type: .normal),ActionSheetItem(title: "Delete", type: .normal),ActionSheetItem(title: "Mute", type: .normal),ActionSheetItem(title: "unmute", type: .normal),ActionSheetItem(title: "Report", type: .destructive)]
    
    /// Description ActionSheet row height.
    static var actionSheetRowHeight: CGFloat = 56
    
    static var giftPlaceHolder: UIImage? = UIImage(systemName: "gift")
    
    static var avatarPlaceHolder: UIImage? = UIImage(named: "default_avatar", in: .chatroomBundle, with: nil)
    
    static var userIdentifyPlaceHolder: UIImage? = nil
    
    static var maxInputHeight: CGFloat = 88
    
    static var inputPlaceHolder = "Aa"
    
    static var inputBarCorner: CornerRadius = .medium
    
    static var avatarRadius: CornerRadius = .large
}
